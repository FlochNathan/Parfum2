...
@.tmr.21 = private unnamed_addr constant [34 x i8] c"android/os/IBinder$DeathRecipient\00", align 1
@.tmr.22 = private unnamed_addr constant [19 x i8] c"android/os/IBinder\00", align 1
@.tmr.23 = private unnamed_addr constant [45 x i8] c"android/os/IBinder$FrozenStateChangeCallback\00", align 1
@.tmr.24 = private unnamed_addr constant [22 x i8] c"android/os/IInterface\00", align 1
@.tmr.25 = private unnamed_addr constant [18 x i8] c"android/os/Looper\00", align 1
@.tmr.26 = private unnamed_addr constant [18 x i8] c"android/os/Parcel\00", align 1
@.tmr.27 = private unnamed_addr constant [27 x i8] c"android/os/VibrationEffect\00", align 1
@.tmr.28 = private unnamed_addr constant [33 x i8] c"android/view/ContextThemeWrapper\00", align 1
@.tmr.29 = private unnamed_addr constant [40 x i8] c"mono/android/runtime/InputStreamAdapter\00", align 1
@.tmr.30 = private unnamed_addr constant [21 x i8] c"java/util/Collection\00", align 1
@.tmr.31 = private unnamed_addr constant [18 x i8] c"java/util/HashMap\00", align 1
@.tmr.32 = private unnamed_addr constant [20 x i8] c"java/util/ArrayList\00", align 1
@.tmr.33 = private unnamed_addr constant [32 x i8] c"mono/android/runtime/JavaObject\00", align 1
@.tmr.34 = private unnamed_addr constant [35 x i8] c"android/runtime/JavaProxyThrowable\00", align 1
@.tmr.35 = private unnamed_addr constant [18 x i8] c"java/util/HashSet\00", align 1
@.tmr.36 = private unnamed_addr constant [41 x i8] c"mono/android/runtime/OutputStreamAdapter\00", align 1
@.tmr.37 = private unnamed_addr constant [24 x i8] c"android/content/Context\00", align 1
@.tmr.38 = private unnamed_addr constant [23 x i8] c"android/content/Intent\00", align 1
@.tmr.39 = private unnamed_addr constant [30 x i8] c"android/content/ComponentName\00", align 1
@.tmr.40 = private unnamed_addr constant [31 x i8] c"android/content/ContextWrapper\00", align 1
@.tmr.41 = private unnamed_addr constant [41 x i8] c"android/content/SharedPreferences$Editor\00", align 1
@.tmr.42 = private unnamed_addr constant [67 x i8] c"android/content/SharedPreferences$OnSharedPreferenceChangeListener\00", align 1
@.tmr.43 = private unnamed_addr constant [34 x i8] c"android/content/SharedPreferences\00", align 1
@.tmr.44 = private unnamed_addr constant [21 x i8] c"android/app/Activity\00", align 1
@.tmr.45 = private unnamed_addr constant [24 x i8] c"android/app/Application\00", align 1
@.tmr.46 = private unnamed_addr constant [25 x i8] c"android/app/Notification\00", align 1
@.tmr.47 = private unnamed_addr constant [33 x i8] c"android/app/Notification$Builder\00", align 1
@.tmr.48 = private unnamed_addr constant [32 x i8] c"android/app/NotificationManager\00", align 1
@.tmr.49 = private unnamed_addr constant [32 x i8] c"android/app/NotificationChannel\00", align 1
@.tmr.50 = private unnamed_addr constant [20 x i8] c"android/app/Service\00", align 1
@.tmr.51 = private unnamed_addr constant [26 x i8] c"java/net/ConnectException\00", align 1
@.tmr.52 = private unnamed_addr constant [27 x i8] c"java/net/HttpURLConnection\00", align 1
@.tmr.53 = private unnamed_addr constant [27 x i8] c"java/net/InetSocketAddress\00", align 1
@.tmr.54 = private unnamed_addr constant [27 x i8] c"java/net/ProtocolException\00", align 1
@.tmr.55 = private unnamed_addr constant [15 x i8] c"java/net/Proxy\00", align 1
@.tmr.56 = private unnamed_addr constant [20 x i8] c"java/net/Proxy$Type\00", align 1
@.tmr.57 = private unnamed_addr constant [23 x i8] c"java/net/SocketAddress\00", align 1
@.tmr.58 = private unnamed_addr constant [25 x i8] c"java/net/SocketException\00", align 1
@.tmr.59 = private unnamed_addr constant [32 x i8] c"java/net/SocketTimeoutException\00", align 1
@.tmr.60 = private unnamed_addr constant [33 x i8] c"java/net/UnknownServiceException\00", align 1
@.tmr.61 = private unnamed_addr constant [13 x i8] c"java/net/URL\00", align 1
@.tmr.62 = private unnamed_addr constant [23 x i8] c"java/net/URLConnection\00", align 1
@.tmr.63 = private unnamed_addr constant [18 x i8] c"java/security/Key\00", align 1
@.tmr.64 = private unnamed_addr constant [24 x i8] c"java/security/Principal\00", align 1
@.tmr.65 = private unnamed_addr constant [25 x i8] c"java/security/PrivateKey\00", align 1
@.tmr.66 = private unnamed_addr constant [25 x i8] c"java/security/KeyFactory\00", align 1
@.tmr.67 = private unnamed_addr constant [23 x i8] c"java/security/KeyStore\00", align 1
@.tmr.68 = private unnamed_addr constant [27 x i8] c"java/security/SecureRandom\00", align 1
@.tmr.69 = private unnamed_addr constant [34 x i8] c"java/security/spec/EncodedKeySpec\00", align 1
@.tmr.70 = private unnamed_addr constant [27 x i8] c"java/security/spec/KeySpec\00", align 1
@.tmr.71 = private unnamed_addr constant [39 x i8] c"java/security/spec/PKCS8EncodedKeySpec\00", align 1
@.tmr.72 = private unnamed_addr constant [31 x i8] c"java/security/cert/Certificate\00", align 1
@.tmr.73 = private unnamed_addr constant [30 x i8] c"java/nio/channels/FileChannel\00", align 1
@.tmr.74 = private unnamed_addr constant [51 x i8] c"java/nio/channels/spi/AbstractInterruptibleChannel\00", align 1
@.tmr.75 = private unnamed_addr constant [23 x i8] c"java/io/FileDescriptor\00", align 1
@.tmr.76 = private unnamed_addr constant [24 x i8] c"java/io/FileInputStream\00", align 1
@.tmr.77 = private unnamed_addr constant [20 x i8] c"java/io/InputStream\00", align 1
@.tmr.78 = private unnamed_addr constant [31 x i8] c"java/io/InterruptedIOException\00", align 1
@.tmr.79 = private unnamed_addr constant [20 x i8] c"java/io/IOException\00", align 1
@.tmr.80 = private unnamed_addr constant [21 x i8] c"java/io/Serializable\00", align 1
@.tmr.81 = private unnamed_addr constant [21 x i8] c"java/io/OutputStream\00", align 1
@.tmr.82 = private unnamed_addr constant [22 x i8] c"java/util/Enumeration\00", align 1
@.tmr.83 = private unnamed_addr constant [19 x i8] c"java/util/Iterator\00", align 1
@.tmr.84 = private unnamed_addr constant [17 x i8] c"java/util/Random\00", align 1
@.tmr.85 = private unnamed_addr constant [28 x i8] c"java/util/function/Consumer\00", align 1
@.tmr.86 = private unnamed_addr constant [30 x i8] c"java/util/concurrent/Executor\00", align 1
@.tmr.87 = private unnamed_addr constant [18 x i8] c"java/lang/Boolean\00", align 1
@.tmr.88 = private unnamed_addr constant [15 x i8] c"java/lang/Byte\00", align 1
@.tmr.89 = private unnamed_addr constant [20 x i8] c"java/lang/Character\00", align 1
@.tmr.90 = private unnamed_addr constant [16 x i8] c"java/lang/Class\00", align 1
@.tmr.91 = private unnamed_addr constant [33 x i8] c"java/lang/ClassNotFoundException\00", align 1
@.tmr.92 = private unnamed_addr constant [17 x i8] c"java/lang/Double\00", align 1
@.tmr.93 = private unnamed_addr constant [20 x i8] c"java/lang/Exception\00", align 1
@.tmr.94 = private unnamed_addr constant [16 x i8] c"java/lang/Float\00", align 1
@.tmr.95 = private unnamed_addr constant [23 x i8] c"java/lang/CharSequence\00", align 1
@.tmr.96 = private unnamed_addr constant [18 x i8] c"java/lang/Integer\00", align 1
@.tmr.97 = private unnamed_addr constant [15 x i8] c"java/lang/Long\00", align 1
@.tmr.98 = private unnamed_addr constant [17 x i8] c"java/lang/Object\00", align 1
@.tmr.99 = private unnamed_addr constant [27 x i8] c"java/lang/RuntimeException\00", align 1
@.tmr.100 = private unnamed_addr constant [16 x i8] c"java/lang/Short\00", align 1
@.tmr.101 = private unnamed_addr constant [17 x i8] c"java/lang/String\00", align 1
@.tmr.102 = private unnamed_addr constant [17 x i8] c"java/lang/Thread\00", align 1
@.tmr.103 = private unnamed_addr constant [35 x i8] c"mono/java/lang/RunnableImplementor\00", align 1
@.tmr.104 = private unnamed_addr constant [20 x i8] c"java/lang/Throwable\00", align 1
@.tmr.105 = private unnamed_addr constant [29 x i8] c"java/lang/ClassCastException\00", align 1
@.tmr.106 = private unnamed_addr constant [15 x i8] c"java/lang/Enum\00", align 1
@.tmr.107 = private unnamed_addr constant [16 x i8] c"java/lang/Error\00", align 1
@.tmr.108 = private unnamed_addr constant [35 x i8] c"java/lang/IllegalArgumentException\00", align 1
@.tmr.109 = private unnamed_addr constant [32 x i8] c"java/lang/IllegalStateException\00", align 1
@.tmr.110 = private unnamed_addr constant [36 x i8] c"java/lang/IndexOutOfBoundsException\00", align 1
@.tmr.111 = private unnamed_addr constant [19 x i8] c"java/lang/Runnable\00", align 1
@.tmr.112 = private unnamed_addr constant [23 x i8] c"java/lang/LinkageError\00", align 1
@.tmr.113 = private unnamed_addr constant [31 x i8] c"java/lang/NoClassDefFoundError\00", align 1
@.tmr.114 = private unnamed_addr constant [31 x i8] c"java/lang/NullPointerException\00", align 1
@.tmr.115 = private unnamed_addr constant [17 x i8] c"java/lang/Number\00", align 1
@.tmr.116 = private unnamed_addr constant [39 x i8] c"java/lang/ReflectiveOperationException\00", align 1
@.tmr.117 = private unnamed_addr constant [28 x i8] c"java/lang/SecurityException\00", align 1
@.tmr.118 = private unnamed_addr constant [28 x i8] c"java/lang/StackTraceElement\00", align 1
@.tmr.119 = private unnamed_addr constant [40 x i8] c"java/lang/UnsupportedOperationException\00", align 1
@.tmr.120 = private unnamed_addr constant [25 x i8] c"mono/android/TypeManager\00", align 1
@.tmr.121 = private unnamed_addr constant [35 x i8] c"crc647257767dbea74abd/MainActivity\00", align 1
@.tmr.122 = private unnamed_addr constant [42 x i8] c"crc647257767dbea74abd/MyForegroundService\00", align 1
@.tmr.123 = private unnamed_addr constant [20 x i8] c"[Ljava/lang/Object;\00", align 1
...
@.tmr.132 = private unnamed_addr constant [37 x i8] c"net/dot/jni/internal/JavaProxyObject\00", align 1
@.tmr.133 = private unnamed_addr constant [40 x i8] c"net/dot/jni/internal/JavaProxyThrowable\00", align 1
@.tmr.134 = private unnamed_addr constant [24 x i8] c"net/dot/jni/ManagedPeer\00", align 1
